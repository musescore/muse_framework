...
namespace muse::testflow::api {
class TestflowApi : public muse::api::ApiObject, public async::Asyncable
{
    Q_OBJECT

    GlobalInject<testflow::ITestflowConfiguration> testflowConfiguration;
...
public:
    explicit TestflowApi(muse::api::IApiEngine* e);
...
#endif // MUSE_TESTFLOW_API_TESTFLOWAPI_H
