 ...
 */
#ifndef MUSE_TESTFLOW_TESTFLOW_H
#define MUSE_TESTFLOW_TESTFLOW_H
...
class Testflow : public ITestflow, public Contextable, public async::Asyncable
{
...
public:
    Testflow(const modularity::ContextPtr& iocCtx)
    ...
    TestflowInteractivePtr testflowInteractive() const override;
...
private:
    ...
    TestflowInteractivePtr m_testflowInteractive = nullptr;
...
#endif // MUSE_TESTFLOW_TESTFLOW_H
