...
public:
    ...
    io::path_t cleanPath(const io::path_t& filePath) const override;
    bool isSymLink(const io::path_t& filePath) const override;
    io::path_t symLinkTarget(const io::path_t& filePath) const override;
