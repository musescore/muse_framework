...
function(muse_create_module target_name)
    ...
    # gtest headers are reachable from any module; googletest is only fetched when unit tests are ON
    if (MUSE_ENABLE_UNIT_TESTS)
        get_property(_gtest_src GLOBAL PROPERTY googletest_SOURCE_DIR)
        target_include_directories(${target_name} PRIVATE ${_gtest_src}/googletest/googletest/include)
    endif()
